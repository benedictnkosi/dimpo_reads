...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.log('');
      console.log('Usage:');
      console.log('  node scripts/populate-dummy-results.cjs populate [attempts] [accuracy]');
      console.log('  node scripts/populate-dummy-results.cjs stats');
      console.log('');
      console.log('Examples:');
      console.log('  node scripts/populate-dummy-results.cjs populate');
      console.log('  node scripts/populate-dummy-results.cjs populate 5 75');
      console.log('  node scripts/populate-dummy-results.cjs stats');
      break;
  }
}
